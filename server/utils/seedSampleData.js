...
const sampleSpaces = [
  {
    ...
    isAvailable: true,
    images: [
      { url: "src/assets/images/udem_campus_laval_1.jpg", isMain: true },
      { url: "src/assets/images/udem_campus_laval_2.jpg", isMain: false },
      { url: "src/assets/images/udem_campus_laval_3.jpg", isMain: false },
    ],
    description:
